...
# ── VPC ──────────────────────────────────────────────────────────────
module "vpc" {
  source = "git::https://github.com/Priyanka-hub-source/Terraform-VPC1.git"
...
module "subnets" {
  source = "git::https://github.com/Priyanka-hub-source/Terraform-subnet.git"
...
module "ec2_instances" {
  source = "git::https://github.com/Priyanka-hub-source/Terraform-Ec2.git"
...
# ── S3 Bucket ─────────────────────────────────────────────────────────
module "s3_bucket" {
  source = "git::https://github.com/Priyanka-hub-source/Terraform-S3.git"
